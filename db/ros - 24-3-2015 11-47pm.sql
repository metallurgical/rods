...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 24, 2015 at 04:46 PM
...
`food_order_id` int(5) NOT NULL,
  `customer_id` int(5) NOT NULL,
  `food_id` int(5) NOT NULL,
  `food_order_notis` text NOT NULL,
  `food_order_delivery` int(5) NOT NULL COMMENT '0- not state, 1 - delivery, 2 - ambik sdri',
  `food_order_status` int(5) NOT NULL COMMENT '0-not yet confirm, 1 - confirm, 2 - delivering process, 3 - delivered, 4 - habis'
...
INSERT INTO `food_order` (`food_order_id`, `customer_id`, `food_id`, `food_order_notis`, `food_order_delivery`, `food_order_status`) VALUES
(43, 1, 6, '', 2, 3),
(44, 1, 1, '', 1, 3),
(45, 1, 3, '', 1, 3),
(47, 1, 4, '', 2, 3);
...
--
ALTER TABLE `food_order`
MODIFY `food_order_id` int(5) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=48;
--
-- AUTO_INCREMENT for table `promotions`
--
ALTER TABLE `promotions`
MODIFY `promotion_id` int(5) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=5;
--
