                        ...
                        <div>
                    		<div class="row">
                              <form class="form-signin mg-btm">
                                ...
                                <input type="text" class="form-control" placeholder="Email" autofocus name="customer_email">
                                <input type="password" class="form-control" placeholder="Password" name="customer_password">
                                 
                                Does't have account ? <a href="<?php echo base_url();?>user_management/register"> Register Here.</a>
